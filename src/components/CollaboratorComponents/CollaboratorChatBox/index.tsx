...
import { BodyChat } from '../../AdmCompanyComponents/ChatBox/bodyChat';
...
import { CollaboratorUserHeader } from './CollaboratorUserHeader';
import { CollaboratorBodyChat } from './CollaboratorBodyChat';
...
export function CollaboratorChatBox ({user}: ChatBoxProps) {
      ...
      return(
        ...
        <div className={styles.container}>
           ...
           <div className={styles.header}>
              ...
              <CollaboratorUserHeader />
           
            </div>
           
           
            <CollaboratorBodyChat 
            user={user}
            />
